...
describe UsersController do
  ...
  describe "POST 'create'" do
    ...
    describe "authetication of edit/update actions" do
      ...
      describe "for singed-in-users" do
          ...
          it "should reqire matching users for 'edit" do
            get :edit, :id => @user
            response.should redirect_to(root_path)
          end
          
          it "should reqire matching users for 'update" do
            put :update, :id => @user, :user => {}
            response.should redirect_to(root_path)
          end
